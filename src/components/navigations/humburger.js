...
function Navigation() {
  ...
  return (
    <>
      <div>
        <nav className="flex lg:flex-col lg:max-w-xs lg:h-screen bg-slate-50 shadow-md border gap-y-24">
          <div className="flex justify-center mt-5">
            <img src={logo} className="w-48" alt="Hotelator. logo" />
          </div>
          <ul className="flex lg:flex-col lg:w-4/5 lg:self-end lg:text-lg font-sans font-extrabold">
